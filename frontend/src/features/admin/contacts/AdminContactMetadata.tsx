...
export function AdminContactMetadata({
  ...
  return (
    <dl className="detail-grid">
      ...
      <DetailRow label="Affiliate" value={contact.affiliateCode} />
      <DetailRow label="Партнер" value={contact.partnerCode} />
      <DetailRow label="Attribution" value={contact.attributionStatus} />
      <DetailRow label="Attribution причина" value={contact.attributionReason} />
      <DetailRow label="Affiliate Click ID" value={contact.affiliateClickId} />
      <DetailRow
        label={dma.privacy}
