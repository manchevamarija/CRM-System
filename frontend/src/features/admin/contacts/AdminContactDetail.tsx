...
export function AdminContactDetail(props: Props) {
  ...
  // The dropdown further below (change responsible centre) still shows real tenant
  // ids (DIGITMAK, VEZILKA, ...) — but this ownership summary uses the friendlier
  // display name, matching the rest of the admin UI.
