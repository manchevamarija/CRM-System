...
const copy = {
  mk: {
    ...
    verifyLead:
      "Со потврдата ја активирате вашата CRM System корисничка сметка.",
  ...
  en: {
    ...
    verifyLead: "Verification activates your CRM System account.",
  ...
  sq: {
    ...
    verifyLead: "Konfirmimi aktivizon llogarinë tuaj CRM System.",
