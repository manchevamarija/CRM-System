  ...
  if (!user?.organizationId) {
    return (
      <section className="page contact">
        <div>
          <span className="kicker">CRM SYSTEM · ORGANISATION</span>
          <h1>
            {language === "mk"
              ? "Организациите ги управува администратор."
              : language === "sq"
                ? "Organizatat menaxhohen nga administratori."
                : "Organisations are managed by the administrator."}
          </h1>
          <p className="lead">
            {language === "mk"
              ? "Кога администраторот ќе ја креира организацијата и ќе го поврзе вашиот профил, таа автоматски ќе се појави во порталот и ќе добиете известување."
              : language === "sq"
                ? "Pasi administratori të krijojë organizatën dhe të lidhë profilin tuaj, ajo do të shfaqet automatikisht dhe do të merrni njoftim."
                : "Once the administrator creates the organisation and links your profile, it will appear automatically and you will receive a notification."}
          </p>
          <button
            className="primary"
            type="button"
