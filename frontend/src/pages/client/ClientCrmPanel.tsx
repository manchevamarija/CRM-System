  ...
  return (
    <article className="client-crm-card">
      ...
      <p className="crm-live-note">
        <span />{" "}
        {text(
          "Овој преглед се ажурира автоматски кога One Stop Shop Portal ќе направи промена.",
          "This view updates automatically when One Stop Shop Portal makes a change.",
          "Ky pasqyrim përditësohet automatikisht kur One Stop Shop Portal bën një ndryshim.",
        )}
      </p>
    </article>
  );
