...
// toLocaleString's 12h/24h behaviour depends on the browser/OS's own locale data,
// which isn't reliably installed for "mk-MK" everywhere — it can silently fall back
// to an English-style 12-hour clock. Format explicitly instead so the time always
// reads the same way the rest of the app (backend, PDFs, emails) already does.
