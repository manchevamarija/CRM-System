...
export type AffiliatePartnerBreakdownStats = {
  id?: string;
  brandCode: string;
  brandName: string;
  partnerCode: string;
...
export type RegisteredAffiliatePartner = {
  id: string;
  brandCode: string;
  brandName: string;
  partnerCode: string;
...
export type AffiliateOverview = {
  partners: AffiliatePartnerStats[];
  partnerBreakdown: AffiliatePartnerBreakdownStats[];
  totals: { clicks: number; formSubmissions: number; leads: number; served: number; conversionRate: number };
};
export type Contact = {
  id: string;
  ...
  partnerCode?: string;
  attributionStatus?: "Attributed" | "BrandAttributed" | "Ambiguous" | "Unattributed";
