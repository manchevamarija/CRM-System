...
export function DmaContactPage({
  onNavigate,
}: {
  onNavigate?: Navigate;
}) {
        ...
        <section className="intake-section">
          ...
          <div className="request-type-grid">
            ...
            >
              <span>◇</span>
              <b>Сакам соработка</b>
              <small>Долгорочно партнерство со One Stop Shop Portal</small>
            </button>
          </div>
        </section>
        <section className="intake-section">
          ...
          <div className="shop-layout">
            ...
            <aside className="service-cart" aria-live="polite">
              ...
              <small className="cart-note">
                Нема онлајн наплата. По испраќањето, One Stop Shop Portal ќе ве контактира
            ...
            <div className="row">
              ...
              <label>
                ...
                <select name="organizationType">
                  ...
                  <option value="NGO">НВО</option>
                  <option value="University">Универзитет/образовна институција</option>
