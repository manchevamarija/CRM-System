  ...
  mk: {
    ...
    terms: [
      [
        ...
        "Содржината и материјалите се користат само за дозволените CRM System услуги, освен ако сопственикот изречно не дозволи поинаку.",
      ],
      [
        "Надворешни услуги",
        "Moodle, календарските и другите надворешни врски може да имаат сопствени услови и политики. CRM System не ги активира без соодветна конфигурација и одобрување.",
      ],
      [
        "Измени на условите",
  ...
  en: {
    ...
    terms: [
      [
        ...
        "Content and materials may be used only for authorised CRM System services unless their owner expressly permits otherwise.",
      ],
      [
        "External services",
        "Moodle, calendar and other external links may have separate terms and policies. CRM System does not activate them without appropriate configuration and approval.",
      ],
      [
  ...
  sq: {
    ...
    terms: [
      [
        ...
        "Përmbajtja dhe materialet përdoren vetëm për shërbimet e autorizuara CRM System, përveç nëse pronari lejon shprehimisht ndryshe.",
      ],
      [
        "Shërbimet e jashtme",
        "Moodle, kalendarët dhe lidhjet e jashtme mund të kenë kushte të veçanta. CRM System nuk i aktivizon pa konfigurim dhe miratim.",
      ],
      [
