    ...
    <div className="ai-contact-page">
      <section className="ai-contact-hero">
        <div className="ai-contact-copy">
          ...
          <p>
            {tx(
              "Најавете се за да ги следите вашите барања, статуси, документи и разговори со One Stop Shop Portal тимот — сè на едно место.",
              "Sign in to track your requests, statuses, documents and conversations with the One Stop Shop Portal team — all in one place.",
              "Kyçuni për të ndjekur kërkesat, statuset, dokumentet dhe bisedat me ekipin One Stop Shop Portal — të gjitha në një vend.",
            )}
          </p>
          <div className="actions">
            <button className="primary" onClick={() => onNavigate("contact")}>
