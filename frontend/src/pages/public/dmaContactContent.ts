...
export const translations: Record<"en" | "sq", Record<string, string>> = {
  en: {
    ...
    "Долгорочно партнерство со One Stop Shop Portal":
      "Long-term cooperation with One Stop Shop Portal",
    ...
    "Нема онлајн наплата. По испраќањето, One Stop Shop Portal ќе ве контактира со персонализирана понуда.":
      "No online payment. One Stop Shop Portal will contact you with a personalised offer after submission.",
    ...
    "Се согласувам One Stop Shop Portal да ме контактира во врска со ова барање.":
      "I agree that One Stop Shop Portal may contact me about this request.",
  ...
  sq: {
    ...
    "Долгорочно партнерство со One Stop Shop Portal":
      "Partneritet afatgjatë me One Stop Shop Portal",
    ...
    "Нема онлајн наплата. По испраќањето, One Stop Shop Portal ќе ве контактира со персонализирана понуда.":
      "Nuk ka pagesë online. One Stop Shop Portal do t’ju kontaktojë me ofertë të personalizuar.",
    ...
    "Над 5.000 €": "Mbi 5.000 €",
    "Се согласувам One Stop Shop Portal да ме контактира во врска со ова барање.":
      "Pajtohem që One Stop Shop Portal të më kontaktojë për këtë kërkesë.",
    "Ја прочитав и ја прифаќам политиката за приватност.":
...
Object.assign(translations.en, {
  ...
  "Добредојдовте во One Stop Shop Portal.": "Welcome to One Stop Shop Portal.",
...
Object.assign(translations.sq, {
  ...
  "Добредојдовте во One Stop Shop Portal.": "Mirë se vini në One Stop Shop Portal.",
...
Object.assign(translations.en, {
  ...
  "Вашето барање и избраните услуги се внесени во One Stop Shop Portal CRM. Креирајте профил со истата е-пошта за да ги следите статусите и следните чекори.":
    "Your request and selected services are now in the One Stop Shop Portal CRM. Create an account with the same email to track statuses and next steps.",
...
Object.assign(translations.sq, {
  ...
  "Вашето барање и избраните услуги се внесени во One Stop Shop Portal CRM. Креирајте профил со истата е-пошта за да ги следите статусите и следните чекори.":
    "Kërkesa dhe shërbimet tuaja janë regjistruar në One Stop Shop Portal CRM. Krijoni llogari me të njëjtin email për të ndjekur statuset dhe hapat vijues.",
  "Вашиот CRM профил и барањето се поврзани. Сите следни чекори можете да ги следите во порталот.":
