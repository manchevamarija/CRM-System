...
public class Organization : TenantEntity
{
    ...
    /// <summary>Brand/centre responsible for this organization (digitmak, bau, vezilka, hpc).</summary>
    public string Brand { get; set; } = "crm";
    public Guid CreatedByUserId { get; set; }
    public Guid? ApprovedBy { get; set; }
    public DateTimeOffset? ApprovedAt { get; set; }
    /// <summary>Optional parent organization, for grouping related organizations
    /// together (e.g. a chamber's member companies) so clients can be moved between
    /// them and admins can see the relationship at a glance.</summary>
