...
namespace CRMSystem.Application.Exports;
...
public static class SpreadsheetExports
{
    ...
    private static readonly IReadOnlyDictionary<string, (string Label, string Example)> FieldCopy =
        new Dictionary<string, (string, string)>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["category"] = ("Категорија", "Дигитална зрелост"),
            ...
            ["kpiCategory"] = ("KPI категорија", "SERVICE_SUPPORT"),
            ...
            ["byCategory"] = ("По категорија", "Дигитална зрелост: 0"),
    ...
    public static byte[] EvidenceTemplate(EvidenceTemplate template)
    {
        ...
        sheet.Cell("A1").Value = "CRM System — One Stop Shop Portal · KPI документација";
        ...
        var brandPrimary = XLColor.FromHtml("#0F5E6E");
        var palePrimary = XLColor.FromHtml("#EAF5F4");
        var line = XLColor.FromHtml("#D9DEE2");

        sheet
            .Range("A1:C1")
            .Style.Fill.SetBackgroundColor(palePrimary)
            .Font.SetFontColor(brandPrimary)
            .Font.SetBold()
            .Font.SetFontSize(18);
        ...
        sheet.Range("A2:C4").Style.Fill.SetBackgroundColor(palePrimary);
    ...
    )
    {
        ...
        sheet
            ...
            .Style.Fill.SetBackgroundColor(XLColor.FromHtml("#EAF5F4"))
            .Font.SetFontColor(XLColor.FromHtml("#0F5E6E"))
            .Font.SetBold()
            .Font.SetFontSize(18);
        sheet.Row(1).Height = 34;
