    ...
    ITenantDirectory tenantDirectory) : IContactRequestService
{
        ...
        string reason)
    {
        ...
        return $"<p>{Text(language, "Почитуван/а", "Dear", "I/E nderuar")} {System.Net.WebUtility.HtmlEncode(item.ContactName)},</p>"
