        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedBrand = table.Column<string>(type: "text", nullable: true),
                    AssignedPartnerCode = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceTenantId = table.Column<string>(type: "text", nullable: true),
                    AffiliateCode = table.Column<string>(type: "text", nullable: true),
                    PartnerCode = table.Column<string>(type: "text", nullable: true),
                    AffiliateClickId = table.Column<string>(type: "text", nullable: true),
                    GoogleFormResponseId = table.Column<string>(type: "text", nullable: true),
                    AttributionStatus = table.Column<string>(type: "text", nullable: false, defaultValue: "Unattributed"),
                    AttributionReason = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApprovalStatus = table.Column<string>(type: "text", nullable: false, defaultValue: "Approved"),
                    SourceApprovedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    SourceApprovedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    DestinationApprovedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    DestinationApprovedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "text", nullable: false),
                    ResolvedOrganizationId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnmatchedCalendarEvents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalCalendarProvider = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    TenantId = table.Column<string>(type: "text", nullable: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AffiliateClicks_TenantId_AffiliateCode_CreatedAt",
                table: "AffiliateClicks",
                columns: new[] { "TenantId", "AffiliateCode", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_AffiliateClicks_AffiliateCode_PartnerCode",
                table: "AffiliateClicks",
                columns: new[] { "AffiliateCode", "PartnerCode" });

            migrationBuilder.CreateIndex(
                name: "IX_AffiliateClicks_ClickId",
                table: "AffiliateClicks",
                column: "ClickId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AffiliatePartners_BrandCode_PartnerCode",
                table: "AffiliatePartners",
                columns: new[] { "BrandCode", "PartnerCode" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AffiliatePartners_LinkedOrganizationId",
                table: "AffiliatePartners",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnmatchedCalendarEvents_CalendarConnectionId",
                table: "UnmatchedCalendarEvents",
                column: "CalendarConnectionId");

            migrationBuilder.CreateIndex(
                name: "IX_Meetings_ExternalEventId",
                table: "Meetings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_AssignedBrand_AssignedPartnerCode",
                table: "AspNetUsers",
                columns: new[] { "AssignedBrand", "AssignedPartnerCode" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactRequests_AffiliateCode",
                table: "ContactRequests",
                column: "AffiliateCode");

            migrationBuilder.CreateIndex(
                name: "IX_ContactRequests_AffiliateCode_PartnerCode",
                table: "ContactRequests",
                columns: new[] { "AffiliateCode", "PartnerCode" });

            migrationBuilder.CreateIndex(
                name: "IX_ContactRequests_AffiliateClickId",
                table: "ContactRequests",
                column: "AffiliateClickId",
                unique: true,
                filter: "\"AffiliateClickId\" IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_ContactRequests_GoogleFormResponseId",
                table: "ContactRequests",
                column: "GoogleFormResponseId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactRequestTransfers_ContactRequestId_ApprovalStatus",
                table: "ContactRequestTransfers",
                columns: new[] { "ContactRequestId", "ApprovalStatus" });
