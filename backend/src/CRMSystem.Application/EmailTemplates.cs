...
public static partial class EmailTemplates
{
    private static readonly Dictionary<string, (string Subject, string Body)> Macedonian = new()
    {
        ["EmailVerification"] = (
            "Потврда на е-пошта",
            "<p>Потврдете ја вашата CRM System сметка за да продолжите.</p>"
        ),
        ["PasswordReset"] = (
            "Промена на лозинка",
            "<p>Добивме барање за промена на лозинката на вашата CRM System сметка.</p>"
        ),
        ...
        ["OrganizationApproved"] = (
            ...
            "<p>Вашата организација е одобрена во CRM System порталот.</p>"
        ),
        ["OrganizationRejected"] = (
            "Организацијата е одбиена",
            "<p>Вашата организација не беше одобрена. Контактирајте го CRM System тимот за дополнителни информации.</p>"
        ),
        ...
        ["SubscriptionInvitation"] = (
            "Покана за претплата",
            "<p>Имате покана за лична годишна CRM System претплата.</p>"
        ),
        ["SubscriptionActivated"] = (
            "Претплатата е активна",
            "<p>Вашата CRM System претплата е активирана.</p>"
        ),
        ["SubscriptionExpiringSoon"] = (
            "Претплатата истекува наскоро",
            "<p>Вашата претплата истекува наскоро. Контактирајте го CRM System тимот за продолжување.</p>"
        ),
        ["SubscriptionExpired"] = (
            "Претплатата е истечена",
            "<p>Вашата CRM System претплата е истечена.</p>"
        ),
        ["SubscriptionCancelled"] = (
            "Претплатата е откажана",
            "<p>Вашата CRM System претплата е откажана.</p>"
        ),
        ...
        ["ContactRequestResponse"] = (
            "Одговор од CRM System",
            "<p>Тимот на CRM System испрати одговор на вашето барање:</p>"
        ),
        ["RegistrationInvitation"] = (
            "Покана за регистрација",
            "<p>Креирајте CRM System сметка за да продолжите со услугата.</p>"
        ),
        ["TicketCreated"] = (
            "Тикетот е креиран",
            "<p>Вашиот тикет е успешно креиран во CRM System порталот.</p>"
        ),
        ["TicketAssigned"] = (
            "Тикетот е доделен",
            "<p>Вашиот тикет е доделен на член од CRM System тимот.</p>"
        ),
        ["TicketStatusChanged"] = (
        ...
        ["TicketMessageCreated"] = (
            ...
            "<p>Имате нова порака во вашиот CRM System тикет.</p>"
        ),
        ["TicketResolved"] = (
            "Тикетот е решен",
        ...
        ["MeetingConfirmed"] = (
            ...
            "<p>Вашиот CRM System состанок е потврден. Деталите се достапни во порталот.</p>"
        ),
        ["MeetingRejected"] = (
            "Состанокот е одбиен",
    ...
    private static readonly Dictionary<string, (string Subject, string Body)> Albanian = new()
    {
        ["EmailVerification"] = (
            ...
            "<p>Konfirmoni llogarinë tuaj CRM System për të vazhduar.</p>"
        ),
        ["PasswordReset"] = (
        ...
        ["OrganizationApproved"] = (
            ...
            "<p>Organizata juaj u miratua në portalin CRM System.</p>"
        ),
        ["OrganizationRejected"] = (
            "Organizata u refuzua",
            "<p>Organizata nuk u miratua. Kontaktoni ekipin CRM System për më shumë informacion.</p>"
        ),
        ["OrganizationSuspended"] = (
        ...
        ["SubscriptionInvitation"] = (
            "Ftesë për abonim",
            "<p>Keni një ftesë për abonim personal vjetor në CRM System.</p>"
        ),
        ["SubscriptionActivated"] = (
            "Abonimi është aktiv",
            "<p>Abonimi juaj CRM System është aktivizuar.</p>"
        ),
        ["SubscriptionExpiringSoon"] = (
            "Abonimi skadon së shpejti",
            "<p>Abonimi juaj skadon së shpejti. Kontaktoni ekipin CRM System për vazhdim.</p>"
        ),
        ["SubscriptionExpired"] = (
            "Abonimi ka skaduar",
            "<p>Abonimi juaj CRM System ka skaduar.</p>"
        ),
        ["SubscriptionCancelled"] = (
            "Abonimi u anulua",
            "<p>Abonimi juaj CRM System është anuluar.</p>"
        ),
        ["ContactRequestConfirmation"] = (
            "Kërkesa u pranua",
        ...
        ["ContactRequestResponse"] = (
            "Përgjigje nga CRM System",
            "<p>Ekipi CRM System dërgoi përgjigje për kërkesën tuaj:</p>"
        ),
        ["RegistrationInvitation"] = (
            "Ftesë për regjistrim",
            "<p>Krijoni llogari CRM System për të vazhduar me shërbimin.</p>"
        ),
        ["TicketCreated"] = (
            "Tiketa u krijua",
            "<p>Tiketa juaj u krijua me sukses në portalin CRM System.</p>"
        ),
        ["TicketAssigned"] = (
            "Tiketa u caktua",
            "<p>Tiketa juaj iu caktua një anëtari të ekipit CRM System.</p>"
        ),
        ["TicketStatusChanged"] = (
        ...
        ["TicketMessageCreated"] = (
            ...
            "<p>Keni një mesazh të ri në tiketën tuaj CRM System.</p>"
        ),
        ["TicketResolved"] = (
            "Tiketa u zgjidh",
        ...
        ["MeetingConfirmed"] = (
            "Takimi u konfirmua",
            "<p>Takimi juaj CRM System u konfirmua. Hollësitë janë në portal.</p>"
        ),
        ["MeetingRejected"] = (
            "Takimi u refuzua",
    ...
    public static (string Subject, string Body) Render(
        ...
        string originalBody,
        string brandName = "CRM System"
    )
    {
        brandName = string.IsNullOrWhiteSpace(brandName) ? "CRM System" : brandName.Trim();
        var htmlBrandName = System.Net.WebUtility.HtmlEncode(brandName);
        if (type == "AdminUserCreated")
            return ($"{brandName} - {originalSubject}", originalBody.Replace("CRM System", htmlBrandName));

        var locale = language is "en" or "sq" ? language : "mk";
        if (locale == "en")
            return (
                $"{brandName} - {originalSubject}",
                $"<p>{htmlBrandName} notification: <strong>{originalSubject}</strong></p>{originalBody.Replace("CRM System", htmlBrandName)}"
            );
        var templates = locale == "sq" ? Albanian : Macedonian;
        if (!templates.TryGetValue(type, out var template))
            return ($"{brandName} - {originalSubject}", originalBody.Replace("CRM System", htmlBrandName));
        var body = template.Body.Replace("CRM System", htmlBrandName);
