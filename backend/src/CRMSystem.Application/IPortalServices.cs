...
public interface IContactRequestService
{
    ...
    Task<ContactRequest?> FindByGoogleFormResponseIdAsync(string responseId, CancellationToken ct);
    Task SetGoogleFormResponseIdAsync(Guid contactRequestId, string responseId, CancellationToken ct);
}
