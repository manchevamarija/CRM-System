...
- `SignedLaunch` when `MOODLE_BASE_URL` and `MOODLE_SSO_SHARED_SECRET` are supplied. The launch contains the One Stop Shop Portal user id, e-mail, display name, language, timestamp and an HMAC-SHA256 signature.
